...
class StockData:
    def __init__(self, id=None, full=True, new_data=False):
        ...
        #
        # fix dates to Datetime objects rather than strings
...
def fetch_fresh_data():
    ...
    for i, name in enumerate(all_stocks[1350:]):
        try:
            ...
            print(name)
            stock.write_data()
        except:  # Sometimes something goes wrong with a fetch request, or  a stock gets delisted.
            print(f"Something went wrong at {name}, index {i}")
